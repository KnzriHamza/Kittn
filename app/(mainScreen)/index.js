...
const Home = () => {
  ...
  const getCategories = () => {
    axiosClient
      ...
      .catch((error) => {
        errorMessage(
          "Failed to get the Categories, Check you internet connetion"
        );
      });
  };
      ...
      >
        ...
        >
          <AlertDialog.Content>
            ...
            <AlertDialog.Body>
              This will remove all data relating to This Note. This action
              cannot be reversed.
            </AlertDialog.Body>
            <AlertDialog.Footer>
              ...
              todos.map((todo) => (
                <Flex key={todo.id}>
                  <Pressable
                    ...
                    maxW="96"
                    shadow="3"
                    bg={colorMode === "dark" ? "coolGray.900" : "warmGray.50"}
                    p="5"
                  >
                    <Note todo={todo}></Note>
                  </Pressable>
              ...
              <Center>
                ...
                >
                  <Box alignItems="center">
                    ...
                    />
                    <Heading color="primary.500">New Note</Heading>
                  </Box>
                </Center>
              </Center>
            )}
      ...
      <Modal isOpen={modalVisible} onClose={() => setModalVisible(false)}>
        <Modal.Content>
          ...
          <Modal.Body>
            ...
            <FormControl>
              <FormControl.Label>Note Category</FormControl.Label>
              <Box maxW="300">
                <Select
                  minWidth="200"
            ...
            <FormControl mt="3">
              ...
              <TextArea
                width="100%"
                defaultValue={selectedTodo ? selectedTodo.todoMessage : ""} // for android and ios
                w="100%"
                maxW="300"
            ...
            <FormControl>
              ...
              <Input
                ...
                Value={selectedTodo ? selectedTodo.todoDate : ""}
              />
            </FormControl>
            <FormControl>
